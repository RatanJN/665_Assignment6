 ...
 * Description: This class conducts JUnit testing for the BeverageMachine, employing the 
 * Given-When-Then format to clearly define test scenarios. Each test method is annotated 
 * with detailed comments explaining the setup conditions (Given), the actions taken (When),
 * and the expected outcomes (Then). This structured approach ensures comprehensive validation
 * of the beverage machine's functionality, including beverage brewing, condiment addition,
 * cost calculation, and adherence to operational constraints. The method definition comments
 * provide additional insight into the purpose and functionality being tested, facilitating easier
 * understanding and maintenance of the test suite. The BeverageMachineTest class is crucial for 
 * ensuring the reliability and correctness of the beverage preparation system, highlighting 
 * the value of automated testing in software development.
 */

package edu.bu.met.cs665;

// These are the import statements required for JUnit testing and 
// accessing the classes to be tested.
...
public class BeverageMachineTest {
  ...
  /**
     * Sets up the test environment before each test. This method initializes the BeverageMachine 
     * instance.
     */
  @Before
  public void setUp() {
  ...
  /**
     * Test to verify the correct calculation of the cost for a Latte Macchiato with one unit of
     * milk added.
  ...
  /**
     * Test to ensure that attempting to brew a beverage without setting a beverage strategy 
